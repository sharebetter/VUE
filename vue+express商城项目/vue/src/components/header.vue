        ...
        <div class="navbar">
          ...
          <div class="navbar-right-container" style="display: flex;">
            <div class="navbar-menu-container">
              ...
              <span class="navbar-link" v-text="userName" v-if="userName"></span>
              ...
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1" name="loginname" v-model="user" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
                  </li>
...
<script>
	...
	export default{
		...
		methods: {
			...
			logOut () {
			  let cmf = window.confirm('是否退出？')
			  if (cmf) {
			  	axios.get('/users/logOut').then((result) => {
			  	  let res = result.data		  	
			  	  // console.log(res)
			  	  if(res.status==0){
			  		// this.userName = ''
			...
			getCartCount(){
              axios.get("users/getCartCount").then( result=>{
                let res = result.data
                // vuex
                this.$store.commit("getCartCount",res.result)
              });
            }
		}
	}
