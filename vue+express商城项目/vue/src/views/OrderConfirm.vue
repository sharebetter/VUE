<template>
  <div>
    <vheader></vheader>
    <vbrander><span>OrderConfirm</span></vbrander>
      ...
      <div class="checkout-order">
        ...
        <div class="order-foot-wrap">
          ...
          <div class="next-btn-wrap">
            <button class="btn btn--m btn--red" @click="payMent"> 支 付 </button>
          </div>
        </div>
      </div>
    </div>
...
import axios from 'axios'
  export default{
      ...
      methods: {
      	getOrderInfo () {
      		axios.get('/users/orderConfirm').then((result) => {
      			let res = result.data
      			if(res.status == 0){
